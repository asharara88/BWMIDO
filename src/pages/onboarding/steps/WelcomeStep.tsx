...
const WelcomeStep = ({ nextStep }: WelcomeStepProps) => (
  <div className="flex flex-col items-center text-center">
    ...
    <h2 className="mb-6 text-2xl font-bold">Let's personalize your health journey</h2>
    <p className="mb-8 text-text-light">
      We'll ask a few questions to understand your health profile and goals. This helps us provide personalized insights and
      recommendations.
    </p>
