...
import { CheckCircle, AlertCircle, Sun, Moon, Clock, Laptop } from 'lucide-react';
        ...
        <div className="mt-6 rounded-xl bg-[hsl(var(--color-card))] p-6 shadow-md">
          ...
          <div className="grid gap-3 sm:grid-cols-2">
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <div className="text-left">
                  <span className="block">Time-Based</span>
                  <span className="text-xs text-text-light">Light (6AM-6PM), Dark (6PM-6AM)</span>
                </div>
              </div>
            ...
            >
              ...
              {theme === 'system' && <CheckCircle className="h-5 w-5" />}
            </button>
          </div>
        </div>
      </div>
