  ...
  if (loading) {
    return (
      <div className="col-span-9 rounded-xl bg-white p-6 shadow-md">
        <h2 className="mb-4 text-xl font-bold">AI Health Coach</h2>
  ...
  return (
    <div className="col-span-9 relative rounded-xl bg-white overflow-hidden shadow-md">
      ...
      <div className="relative z-10 p-6">
        <div className="mb-6">
          <h2 className="text-2xl font-bold text-primary">AI Health Coach</h2>
          ...
          {chatHistory.length === 0 ? (
            <div className="rounded-lg bg-gray-50 p-4 text-center text-text-light">
              ...
              <p className="mt-1 text-sm">
                Start chatting with your AI coach for personalized health advice.
              </p>
            </div>
          ) : (
