...
import { X, ShoppingCart, Minus, Plus, Trash2, ChevronRight, CreditCard } from 'lucide-react';
    ...
    <div className="h-full">
      ...
      {!isOpen && (
        <div className="rounded-xl border border-[hsl(var(--color-border))] bg-[hsl(var(--color-card))] p-4 sm:p-6">
          <div className="mb-4">
            <ImageWithFallback
              src="https://leznzqfezoofngumpiqf.supabase.co/storage/v1/object/sign/people/supps.png?token=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCIsImtpZCI6InN0b3JhZ2UtdXJsLXNpZ25pbmcta2V5X2UyYTcyNGEyLTZkNTctNDk4YS04ZGU1LWY2Y2Q4MjAyNjA3YiJ9.eyJ1cmwiOiJwZW9wbGUvc3VwcHMucG5nIiwiaWF0IjoxNzQ2NDIyODk5LCJleHAiOjE3Nzc5NTg4OTl9.9_KkmsoSU2pOX16TMAPp4Ue8tUAckjhY2dhpBEDLhJw"
              alt="Your Supplement Cart"
