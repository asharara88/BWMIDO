...
/**
 * Supabase Edge Function acting as an OpenAI proxy.
 * It applies a simple rate limit and logs errors to Sentry.
 */
const corsHeaders = {
...
export async function handleRequest(req: Request): Promise<Response> {
  ...
  try {
    ...
    // For demo purposes respond with the last message echoed
